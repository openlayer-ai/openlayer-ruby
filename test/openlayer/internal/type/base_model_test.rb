...
class Openlayer::Test::PrimitiveModelTest < Minitest::Test
  A = Openlayer::Internal::Type::ArrayOf[-> { Integer }]
  H = Openlayer::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Openlayer::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Openlayer::Internal::Type::Unknown,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Openlayer::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Openlayer::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Openlayer::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Openlayer::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Openlayer::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Openlayer::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Openlayer::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Openlayer::Internal::Type::Boolean, true] => true,
      [Openlayer::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Openlayer::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Openlayer::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Openlayer::Internal::Type::Converter.new_coerce_state
      Openlayer::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Openlayer::Internal::Type::Converter.dump(target, input, state: state)
...
class Openlayer::Test::EnumModelTest < Minitest::Test
  class E0
    include Openlayer::Internal::Type::Enum
...
class Openlayer::Test::CollectionModelTest < Minitest::Test
  A1 = Openlayer::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Openlayer::Internal::Type::HashOf[Integer]

  A2 = Openlayer::Internal::Type::ArrayOf[H1]
  H2 = Openlayer::Internal::Type::HashOf[-> { A1 }]

  A3 = Openlayer::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Openlayer::Internal::Type::HashOf[Integer, nil?: true]
...
class Openlayer::Test::BaseModelTest < Minitest::Test
  class M1 < Openlayer::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Openlayer::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Openlayer::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Openlayer::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Openlayer::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Openlayer::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Openlayer::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Openlayer::Errors::ConversionError => e
...
class Openlayer::Test::UnionTest < Minitest::Test
  class U0
    include Openlayer::Internal::Type::Union
  ...
  class M2 < Openlayer::Internal::Type::BaseModel
  ...
  class M4 < Openlayer::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Openlayer::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Openlayer::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Openlayer::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Openlayer::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Openlayer::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Openlayer::Internal::Type::Unknown, Openlayer::Internal::Type::Unknown] => true,
      [Openlayer::Internal::Type::Boolean, Openlayer::Internal::Type::Boolean] => true,
      [Openlayer::Internal::Type::Unknown, Openlayer::Internal::Type::Boolean] => false,
...
class Openlayer::Test::MetaInfoTest < Minitest::Test
  A1 = Openlayer::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Openlayer::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
