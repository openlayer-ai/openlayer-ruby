  ...
  def test_create_required_params
    ...
    assert_pattern do
      response => {
        ...
        default_to_all_pipelines: Openlayer::Internal::Type::Boolean | nil,
        delay_window: Float | nil,
        evaluation_window: Float | nil,
        exclude_pipelines: ^(Openlayer::Internal::Type::ArrayOf[String]) | nil,
        include_historical_data: Openlayer::Internal::Type::Boolean | nil,
        include_pipelines: ^(Openlayer::Internal::Type::ArrayOf[String]) | nil,
