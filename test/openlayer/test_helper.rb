...
class Openlayer::Test::SingletonClient < Openlayer::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Openlayer::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Openlayer::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @openlayer = Openlayer::Test::SingletonClient.instance
  end
