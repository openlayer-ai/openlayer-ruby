...
class OpenlayerTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    ...
    openlayer = Openlayer::Client.new(base_url: "http://localhost", api_key: "My API Key")
  ...
  def test_client_given_request_default_retry_attempts
    ...
    openlayer = Openlayer::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 3)
  ...
  def test_client_redirect_307
    ...
    assert_raises(Openlayer::Errors::APIConnectionError) do
      openlayer.inference_pipelines.data.stream(
        "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        config: {outputColumnName: "output"},
        rows: [{user_query: "bar", output: "bar", tokens: "bar", cost: "bar", timestamp: "bar"}],
    ...
    assert_requested(:any, "http://localhost/redirected", times: Openlayer::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: Openlayer::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: Openlayer::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
