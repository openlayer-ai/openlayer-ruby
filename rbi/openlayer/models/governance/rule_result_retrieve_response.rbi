    ...
    module Governance
      class RuleResultRetrieveResponse < Openlayer::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Openlayer::Models::Governance::RuleResultRetrieveResponse,
        ...
        sig do
          params(
            blocked_by:
              T::Array[
                Openlayer::Models::Governance::RuleResultRetrieveResponse::BlockedBy::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Openlayer::Models::Governance::RuleResultRetrieveResponse::Blocking
              ]
            )
          )
        end
        ...
        sig do
          params(
            blocking:
              T::Array[
                Openlayer::Models::Governance::RuleResultRetrieveResponse::Blocking::OrHash
              ]
          ).void
        end
        ...
        sig do
          params(
            ...
            rule_id: String,
            status:
              Openlayer::Models::Governance::RuleResultRetrieveResponse::Status::OrSymbol,
            workspace_id: String,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Openlayer::Models::Governance::RuleResultRetrieveResponse::Status
              )
            end
        ...
        class BlockedBy < Openlayer::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Openlayer::Models::Governance::RuleResultRetrieveResponse::BlockedBy::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Openlayer::Models::Governance::RuleResultRetrieveResponse::BlockedBy::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Openlayer::Models::Governance::RuleResultRetrieveResponse::BlockedBy::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Blocking < Openlayer::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Openlayer::Models::Governance::RuleResultRetrieveResponse::Blocking::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Openlayer::Models::Governance::RuleResultRetrieveResponse::Blocking::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Openlayer::Models::Governance::RuleResultRetrieveResponse::Blocking::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
