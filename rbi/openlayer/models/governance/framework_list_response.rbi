  ...
  module Models
    module Governance
      class FrameworkListResponse < Openlayer::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[Openlayer::Models::Governance::FrameworkListResponse::Item]
          )
        end
        attr_accessor :items
        ...
        sig do
          params(
            items:
              T::Array[
                Openlayer::Models::Governance::FrameworkListResponse::Item::OrHash
              ]
        ...
        class Item < Openlayer::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Openlayer::Models::Governance::FrameworkListResponse::Item::Avatar
              )
            )
          end
          attr_reader :avatar
          ...
          sig do
            params(
              avatar:
                T.nilable(
                  Openlayer::Models::Governance::FrameworkListResponse::Item::Avatar::OrHash
                )
            ).void
          end
          attr_writer :avatar
          ...
          sig do
            params(
              project_selector:
                T.nilable(
                  Openlayer::Models::Governance::FrameworkListResponse::Item::ProjectSelector::OrHash
                )
            ).void
          end
          ...
          sig do
            params(
              rule_stats:
                Openlayer::Models::Governance::FrameworkListResponse::Item::RuleStats::OrHash
            ).void
          end
          ...
          class Avatar < Openlayer::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Openlayer::Models::Governance::FrameworkListResponse::Item::Avatar::Type::TaggedSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              params(
                type:
                  Openlayer::Models::Governance::FrameworkListResponse::Item::Avatar::Type::OrSymbol,
                value: String
              ).returns(T.attached_class)
            end
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Openlayer::Models::Governance::FrameworkListResponse::Item::Avatar::Type
                  )
                end
          ...
          class ProjectSelector < Openlayer::Internal::Type::BaseModel
            ...
            sig do
              params(
                match:
                  T.nilable(
                    T::Array[
                      Openlayer::Models::Governance::FrameworkListResponse::Item::ProjectSelector::Match::OrHash
                    ]
                  )
              ).returns(T.attached_class)
            end
            ...
            class Match < Openlayer::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  Openlayer::Models::Governance::FrameworkListResponse::Item::ProjectSelector::Match::Property::TaggedSymbol
                )
              end
              ...
              sig do
                params(
                  property:
                    Openlayer::Models::Governance::FrameworkListResponse::Item::ProjectSelector::Match::Property::OrSymbol,
                  value: T.anything,
                  operator: String
                ).returns(T.attached_class)
              end
              ...
              module Property
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Openlayer::Models::Governance::FrameworkListResponse::Item::ProjectSelector::Match::Property
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class RuleStats < Openlayer::Internal::Type::BaseModel
            ...
            sig do
              params(
                project_completion:
                  Openlayer::Models::Governance::FrameworkListResponse::Item::RuleStats::ProjectCompletion::OrHash
              ).void
            end
            ...
            sig do
              params(
                rule_results:
                  Openlayer::Models::Governance::FrameworkListResponse::Item::RuleStats::RuleResults::OrHash
              ).void
            end
