    ...
    module Governance
      class RuleResultListResponse < Openlayer::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Openlayer::Models::Governance::RuleResultListResponse,
        ...
        sig do
          params(
            items:
              T::Array[
                Openlayer::Models::Governance::RuleResultListResponse::Item::OrHash
              ]
        ...
        class Item < Openlayer::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Openlayer::Models::Governance::RuleResultListResponse::Item::BlockedBy
                ]
              )
            )
          end
          ...
          sig do
            params(
              blocked_by:
                T::Array[
                  Openlayer::Models::Governance::RuleResultListResponse::Item::BlockedBy::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Openlayer::Models::Governance::RuleResultListResponse::Item::Blocking
                ]
              )
            )
          end
          ...
          sig do
            params(
              blocking:
                T::Array[
                  Openlayer::Models::Governance::RuleResultListResponse::Item::Blocking::OrHash
                ]
            ).void
          end
          ...
          sig do
            params(
              ...
              rule_id: String,
              status:
                Openlayer::Models::Governance::RuleResultListResponse::Item::Status::OrSymbol,
              workspace_id: String,
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Openlayer::Models::Governance::RuleResultListResponse::Item::Status
                )
              end
          ...
          class BlockedBy < Openlayer::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Openlayer::Models::Governance::RuleResultListResponse::Item::BlockedBy::Status::TaggedSymbol
                )
              )
            end
            attr_reader :status
            ...
            sig do
              params(
                status:
                  Openlayer::Models::Governance::RuleResultListResponse::Item::BlockedBy::Status::OrSymbol
              ).void
            end
            attr_writer :status
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Openlayer::Models::Governance::RuleResultListResponse::Item::BlockedBy::Status
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class Blocking < Openlayer::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Openlayer::Models::Governance::RuleResultListResponse::Item::Blocking::Status::TaggedSymbol
                )
              )
            end
            attr_reader :status
            ...
            sig do
              params(
                status:
                  Openlayer::Models::Governance::RuleResultListResponse::Item::Blocking::Status::OrSymbol
              ).void
            end
            attr_writer :status
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Openlayer::Models::Governance::RuleResultListResponse::Item::Blocking::Status
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
