    ...
    module Governance
      class RuleRetrieveResponse < Openlayer::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Openlayer::Models::Governance::RuleRetrieveResponse,
        ...
        sig do
          returns(
            T.nilable(
              Openlayer::Models::Governance::RuleRetrieveResponse::EvidenceType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Openlayer::Models::Governance::RuleRetrieveResponse::Framework
              ]
            )
          )
        end
        ...
        sig do
          params(
            frameworks:
              T::Array[
                Openlayer::Models::Governance::RuleRetrieveResponse::Framework::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Openlayer::Models::Governance::RuleRetrieveResponse::Result
              ]
            )
          )
        end
        ...
        sig do
          params(
            results:
              T::Array[
                Openlayer::Models::Governance::RuleRetrieveResponse::Result::OrHash
              ]
          ).void
        end
        attr_writer :results
        ...
        sig do
          params(
            results_summary:
              T.nilable(
                Openlayer::Models::Governance::RuleRetrieveResponse::ResultsSummary::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Openlayer::Models::Governance::RuleRetrieveResponse::Tag]
            )
          )
        end
        attr_accessor :tags
        ...
        sig do
          params(
            ...
            name: String,
            scope:
              Openlayer::Models::Governance::RuleRetrieveResponse::Scope::OrSymbol,
            type:
              Openlayer::Models::Governance::RuleRetrieveResponse::Type::OrSymbol,
            workspace_id: String,
            ...
            evidence_type:
              T.nilable(
                Openlayer::Models::Governance::RuleRetrieveResponse::EvidenceType::OrSymbol
              ),
            frameworks:
              T::Array[
                Openlayer::Models::Governance::RuleRetrieveResponse::Framework::OrHash
            ...
            tags:
              T.nilable(
                T::Array[
                  Openlayer::Models::Governance::RuleRetrieveResponse::Tag::OrHash
                ]
              )
        ...
        module Scope
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Openlayer::Models::Governance::RuleRetrieveResponse::Scope
              )
            end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Openlayer::Models::Governance::RuleRetrieveResponse::Type
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module EvidenceType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Openlayer::Models::Governance::RuleRetrieveResponse::EvidenceType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Framework < Openlayer::Internal::Type::BaseModel
          ...
          sig do
            params(
              avatar:
                T.nilable(
                  Openlayer::Models::Governance::RuleRetrieveResponse::Framework::Avatar::OrHash
                )
            ).void
          end
          attr_writer :avatar
          ...
          class Avatar < Openlayer::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Openlayer::Models::Governance::RuleRetrieveResponse::Framework::Avatar::Type::TaggedSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              params(
                type:
                  Openlayer::Models::Governance::RuleRetrieveResponse::Framework::Avatar::Type::OrSymbol,
                value: String
              ).returns(T.attached_class)
            end
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Openlayer::Models::Governance::RuleRetrieveResponse::Framework::Avatar::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Result < Openlayer::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Openlayer::Models::Governance::RuleRetrieveResponse::Result::BlockedBy
                ]
              )
            )
          end
          ...
          sig do
            params(
              blocked_by:
                T::Array[
                  Openlayer::Models::Governance::RuleRetrieveResponse::Result::BlockedBy::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Openlayer::Models::Governance::RuleRetrieveResponse::Result::Blocking
                ]
              )
            )
          end
          ...
          sig do
            params(
              blocking:
                T::Array[
                  Openlayer::Models::Governance::RuleRetrieveResponse::Result::Blocking::OrHash
                ]
            ).void
          end
          ...
          sig do
            params(
              ...
              rule_id: String,
              status:
                Openlayer::Models::Governance::RuleRetrieveResponse::Result::Status::OrSymbol,
              workspace_id: String,
              assignee_id: T.nilable(String),
              blocked_by:
                T::Array[
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Openlayer::Models::Governance::RuleRetrieveResponse::Result::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class BlockedBy < Openlayer::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Openlayer::Models::Governance::RuleRetrieveResponse::Result::BlockedBy::Status::TaggedSymbol
                )
              )
            end
            attr_reader :status
            ...
            sig do
              params(
                status:
                  Openlayer::Models::Governance::RuleRetrieveResponse::Result::BlockedBy::Status::OrSymbol
              ).void
            end
            attr_writer :status
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Openlayer::Models::Governance::RuleRetrieveResponse::Result::BlockedBy::Status
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class Blocking < Openlayer::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Openlayer::Models::Governance::RuleRetrieveResponse::Result::Blocking::Status::TaggedSymbol
                )
              )
            end
            attr_reader :status
            ...
            sig do
              params(
                status:
                  Openlayer::Models::Governance::RuleRetrieveResponse::Result::Blocking::Status::OrSymbol
              ).void
            end
            attr_writer :status
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Openlayer::Models::Governance::RuleRetrieveResponse::Result::Blocking::Status
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
