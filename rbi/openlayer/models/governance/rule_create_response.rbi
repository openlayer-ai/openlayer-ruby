  ...
  module Models
    module Governance
      class RuleCreateResponse < Openlayer::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Openlayer::Models::Governance::RuleCreateResponse::Scope::TaggedSymbol
          )
        end
        attr_accessor :scope
        ...
        sig do
          returns(
            Openlayer::Models::Governance::RuleCreateResponse::Type::TaggedSymbol
          )
        end
        attr_accessor :type
        ...
        sig do
          returns(
            T.nilable(
              Openlayer::Models::Governance::RuleCreateResponse::EvidenceType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Openlayer::Models::Governance::RuleCreateResponse::Framework
              ]
            )
          )
        end
        ...
        sig do
          params(
            frameworks:
              T::Array[
                Openlayer::Models::Governance::RuleCreateResponse::Framework::OrHash
              ]
          ).void
        end
        ...
        sig do
          params(
            results:
              T::Array[
                Openlayer::Models::Governance::RuleCreateResponse::Result::OrHash
              ]
          ).void
        end
        attr_writer :results
        ...
        sig do
          params(
            results_summary:
              T.nilable(
                Openlayer::Models::Governance::RuleCreateResponse::ResultsSummary::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Openlayer::Models::Governance::RuleCreateResponse::Tag]
            )
          )
        end
        attr_accessor :tags
        ...
        sig do
          params(
            ...
            name: String,
            scope:
              Openlayer::Models::Governance::RuleCreateResponse::Scope::OrSymbol,
            type:
              Openlayer::Models::Governance::RuleCreateResponse::Type::OrSymbol,
            workspace_id: String,
            ...
            evidence_type:
              T.nilable(
                Openlayer::Models::Governance::RuleCreateResponse::EvidenceType::OrSymbol
              ),
            frameworks:
              T::Array[
                Openlayer::Models::Governance::RuleCreateResponse::Framework::OrHash
            ...
            tags:
              T.nilable(
                T::Array[
                  Openlayer::Models::Governance::RuleCreateResponse::Tag::OrHash
                ]
              )
          ...
          override.returns(
            {
              ...
              tags:
                T.nilable(
                  T::Array[
                    Openlayer::Models::Governance::RuleCreateResponse::Tag
                  ]
                )
            }
          )
        ...
        module Scope
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Openlayer::Models::Governance::RuleCreateResponse::Scope
              )
            end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Openlayer::Models::Governance::RuleCreateResponse::Type
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module EvidenceType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Openlayer::Models::Governance::RuleCreateResponse::EvidenceType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Framework < Openlayer::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Openlayer::Models::Governance::RuleCreateResponse::Framework::Avatar
              )
            )
          end
          attr_reader :avatar
          ...
          sig do
            params(
              avatar:
                T.nilable(
                  Openlayer::Models::Governance::RuleCreateResponse::Framework::Avatar::OrHash
                )
            ).void
          end
          attr_writer :avatar
          ...
          class Avatar < Openlayer::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Openlayer::Models::Governance::RuleCreateResponse::Framework::Avatar::Type::TaggedSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              params(
                type:
                  Openlayer::Models::Governance::RuleCreateResponse::Framework::Avatar::Type::OrSymbol,
                value: String
              ).returns(T.attached_class)
            end
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Openlayer::Models::Governance::RuleCreateResponse::Framework::Avatar::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Result < Openlayer::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Openlayer::Models::Governance::RuleCreateResponse::Result::Status::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Openlayer::Models::Governance::RuleCreateResponse::Result::BlockedBy
                ]
              )
            )
          end
          ...
          sig do
            params(
              blocked_by:
                T::Array[
                  Openlayer::Models::Governance::RuleCreateResponse::Result::BlockedBy::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Openlayer::Models::Governance::RuleCreateResponse::Result::Blocking
                ]
              )
            )
          end
          ...
          sig do
            params(
              blocking:
                T::Array[
                  Openlayer::Models::Governance::RuleCreateResponse::Result::Blocking::OrHash
                ]
            ).void
          end
          ...
          sig do
            params(
              ...
              rule_id: String,
              status:
                Openlayer::Models::Governance::RuleCreateResponse::Result::Status::OrSymbol,
              workspace_id: String,
              assignee_id: T.nilable(String),
              blocked_by:
                T::Array[
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Openlayer::Models::Governance::RuleCreateResponse::Result::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class BlockedBy < Openlayer::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Openlayer::Models::Governance::RuleCreateResponse::Result::BlockedBy::Status::TaggedSymbol
                )
              )
            end
            attr_reader :status
            ...
            sig do
              params(
                status:
                  Openlayer::Models::Governance::RuleCreateResponse::Result::BlockedBy::Status::OrSymbol
              ).void
            end
            attr_writer :status
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Openlayer::Models::Governance::RuleCreateResponse::Result::BlockedBy::Status
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class Blocking < Openlayer::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Openlayer::Models::Governance::RuleCreateResponse::Result::Blocking::Status::TaggedSymbol
                )
              )
            end
            attr_reader :status
            ...
            sig do
              params(
                status:
                  Openlayer::Models::Governance::RuleCreateResponse::Result::Blocking::Status::OrSymbol
              ).void
            end
            attr_writer :status
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Openlayer::Models::Governance::RuleCreateResponse::Result::Blocking::Status
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
