    ...
    module Governance
      class FrameworkListProjectsResponse < Openlayer::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              Openlayer::Models::Governance::FrameworkListProjectsResponse::Item
            ]
          )
        end
        attr_accessor :items
        ...
        sig do
          params(
            items:
              T::Array[
                Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::OrHash
              ]
        ...
        class Item < Openlayer::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::TaskType::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::Links
            )
          end
          attr_reader :links
          ...
          sig do
            params(
              links:
                Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::Links::OrHash
            ).void
          end
          attr_writer :links
          ...
          sig do
            returns(
              T.nilable(
                Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::Source::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              git_repo:
                T.nilable(
                  Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::GitRepo::OrHash
                )
            ).void
          end
          ...
          sig do
            params(
              ...
              source:
                T.nilable(
                  Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::Source::OrSymbol
                ),
              task_type:
                Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::TaskType::OrSymbol,
          ...
          module Source
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::Source
                )
              end
          ...
          module TaskType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::TaskType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
