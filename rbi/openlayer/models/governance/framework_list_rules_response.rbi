    ...
    module Governance
      class FrameworkListRulesResponse < Openlayer::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              Openlayer::Models::Governance::FrameworkListRulesResponse::Item
            ]
          )
        end
        attr_accessor :items
        ...
        sig do
          params(
            items:
              T::Array[
                Openlayer::Models::Governance::FrameworkListRulesResponse::Item::OrHash
              ]
        ...
        class Item < Openlayer::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Scope::TaggedSymbol
            )
          end
          attr_accessor :scope
          ...
          sig do
            returns(
              Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            returns(
              T.nilable(
                Openlayer::Models::Governance::FrameworkListRulesResponse::Item::EvidenceType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework
                ]
              )
            )
          end
          ...
          sig do
            params(
              frameworks:
                T::Array[
                  Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework::OrHash
                ]
            ).void
          end
          ...
          sig do
            params(
              results:
                T::Array[
                  Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::OrHash
                ]
            ).void
          end
          attr_writer :results
          ...
          sig do
            params(
              results_summary:
                T.nilable(
                  Openlayer::Models::Governance::FrameworkListRulesResponse::Item::ResultsSummary::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Tag
                ]
              )
            )
          end
          ...
          sig do
            params(
              ...
              name: String,
              scope:
                Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Scope::OrSymbol,
              type:
                Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Type::OrSymbol,
              workspace_id: String,
              ...
              evidence_type:
                T.nilable(
                  Openlayer::Models::Governance::FrameworkListRulesResponse::Item::EvidenceType::OrSymbol
                ),
              frameworks:
                T::Array[
                  Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework::OrHash
              ...
              tags:
                T.nilable(
                  T::Array[
                    Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Tag::OrHash
                  ]
                )
            ).returns(T.attached_class)
          end
          ...
          module Scope
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Scope
                )
              end
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module EvidenceType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Openlayer::Models::Governance::FrameworkListRulesResponse::Item::EvidenceType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class Framework < Openlayer::Internal::Type::BaseModel
            ...
            sig do
              params(
                avatar:
                  T.nilable(
                    Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework::Avatar::OrHash
                  )
              ).void
            end
            attr_writer :avatar
            ...
            class Avatar < Openlayer::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework::Avatar::Type::TaggedSymbol
                )
              end
              attr_accessor :type
              ...
              sig do
                params(
                  type:
                    Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework::Avatar::Type::OrSymbol,
                  value: String
                ).returns(T.attached_class)
              end
              ...
              module Type
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework::Avatar::Type
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class Result < Openlayer::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Status::TaggedSymbol
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::BlockedBy
                  ]
                )
              )
            end
            ...
            sig do
              params(
                blocked_by:
                  T::Array[
                    Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::BlockedBy::OrHash
                  ]
              ).void
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Blocking
                  ]
                )
              )
            end
            ...
            sig do
              params(
                blocking:
                  T::Array[
                    Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Blocking::OrHash
                  ]
              ).void
            end
            ...
            sig do
              params(
                ...
                rule_id: String,
                status:
                  Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Status::OrSymbol,
                workspace_id: String,
                assignee_id: T.nilable(String),
                blocked_by:
                  T::Array[
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Status
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            class BlockedBy < Openlayer::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::BlockedBy::Status::TaggedSymbol
                  )
                )
              end
              attr_reader :status
              ...
              sig do
                params(
                  status:
                    Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::BlockedBy::Status::OrSymbol
                ).void
              end
              attr_writer :status
              ...
              module Status
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::BlockedBy::Status
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            class Blocking < Openlayer::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Blocking::Status::TaggedSymbol
                  )
                )
              end
              attr_reader :status
              ...
              sig do
                params(
                  status:
                    Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Blocking::Status::OrSymbol
                ).void
              end
              attr_writer :status
              ...
              module Status
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Blocking::Status
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
