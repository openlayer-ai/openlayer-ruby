    ...
    module Type
      class BaseModel
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Openlayer::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  Openlayer::Internal::Type::BaseModel::KnownField,
                  { type: Openlayer::Internal::Type::Converter::Input }
                )
              ]
            )
          end
            ...
            params(
              ...
              type_info:
                T.any(
                  ...
                  T.proc.returns(Openlayer::Internal::Type::Converter::Input),
                  Openlayer::Internal::Type::Converter::Input
                ),
              spec: Openlayer::Internal::AnyHash
            ).void
          end
          ...
          sig do
            override
              .params(
                ...
                state: Openlayer::Internal::Type::Converter::CoerceState
              )
          ...
          sig do
            override
              .params(
                ...
                state: Openlayer::Internal::Type::Converter::DumpState
              )
        ...
        class << self
          ...
          sig do
            params(
              model: Openlayer::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(Openlayer::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(Openlayer::Internal::AnyHash) }
        def to_h
        end
