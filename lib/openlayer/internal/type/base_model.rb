    ...
    module Type
      ...
      class BaseModel
        ...
        class << self
          ...
          #
          # @param child [Class<Openlayer::Internal::Type::BaseModel>]
          def inherited(child)
            super
          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            ...
            type_fn, info =
              case type_info
              in Proc | Openlayer::Internal::Type::Converter | Class
                [Openlayer::Internal::Type::Converter.type_info({**spec, union: type_info}), spec]
              in Hash
                [Openlayer::Internal::Type::Converter.type_info(type_info), type_info]
              end

            setter = :"#{name_sym}="
            api_name = info.fetch(:api_name, name_sym)
            nilable = info.fetch(:nil?, false)
            const = required && !nilable ? info.fetch(:const, Openlayer::Internal::OMIT) : Openlayer::Internal::OMIT
            ...
            define_method(setter) do |value|
              target = type_fn.call
              state = Openlayer::Internal::Type::Converter.new_coerce_state(translate_names: false)
              ...
              stored =
                case [target, status]
                in [Openlayer::Internal::Type::Converter | Symbol, true]
                  coerced
                else
                  value
                end
            ...
            define_method(name_sym) do
              ...
              in true | false if Openlayer::Internal::Type::Converter === target
                @data.fetch(name_sym)
              in ::StandardError => e
                raise Openlayer::Errors::ConversionError.new(
                  on: self.class,
                  method: __method__,
                  target: target,
                ...
                Kernel.then do
                  value = @data.fetch(name_sym) { const == Openlayer::Internal::OMIT ? nil : const }
                  state = Openlayer::Internal::Type::Converter.new_coerce_state(translate_names: false)
                  if (nilable || !required) && value.nil?
                    nil
                  else
                    Openlayer::Internal::Type::Converter.coerce(
          ...
          # @return [Boolean]
          def ==(other)
            other.is_a?(Class) && other <= Openlayer::Internal::Type::BaseModel && other.fields == fields
          end
        ...
        class << self
          # @api private
          #
          # @param value [Openlayer::Internal::Type::BaseModel, Hash{Object=>Object}, Object]
          #
          ...
          def coerce(value, state:)
            ...
            unless (val = Openlayer::Internal::Util.coerce_hash(value)).is_a?(Hash)
              exactness[:no] += 1
            ...
            fields.each do |name, field|
              ...
              unless val.key?(src_name)
                if required && mode != :dump && const == Openlayer::Internal::OMIT
              ...
              converted =
                if item.nil? && (nilable || !required)
                  ...
                  coerced = Openlayer::Internal::Type::Converter.coerce(target, item, state: state)
                  case target
                  in Openlayer::Internal::Type::Converter | Symbol
                    coerced
                  else
                    item
                  end
          ...
          def dump(value, state:)
            unless (coerced = Openlayer::Internal::Util.coerce_hash(value)).is_a?(Hash)
              return super
            end
            ...
            coerced.each do |key, val|
              ...
              in nil
                ...
                in :coerce
                  ...
                  target = type_fn.call
                  acc.store(api_name, Openlayer::Internal::Type::Converter.dump(target, val, state: state))
                end
              end
            end
            ...
            known_fields.each_value do |field|
              ...
              next if mode == :coerce || acc.key?(api_name) || const == Openlayer::Internal::OMIT
        ...
        class << self
          # @api private
          #
          # @param model [Openlayer::Internal::Type::BaseModel]
            ...
            rec = ->(x) do
              ...
              in Openlayer::Internal::Type::BaseModel
                if convert
                  ...
                  rescue Openlayer::Errors::ConversionError
                    [key, rec.call(val)]
                  end
                else
                  rec.call(x.to_h)
        ...
        #
        # @example
        #   # `project_create_response` is a `Openlayer::Models::ProjectCreateResponse`
        ...
        #
        # @return [String]
        def to_json(*a) = Openlayer::Internal::Type::Converter.dump(self.class, self).to_json(*a)
        ...
        #
        # @return [String]
        def to_yaml(*a) = Openlayer::Internal::Type::Converter.dump(self.class, self).to_yaml(*a)
        ...
        def initialize(data = {})
          @data = {}
          @coerced = {}
          Openlayer::Internal::Util.coerce_hash!(data).each do
        ...
        class << self
          ...
          def inspect(depth: 0)
            ...
            deferred = fields.transform_values do |field|
              ...
              inspected = [
                Openlayer::Internal::Type::Converter.inspect(type, depth: depth),
