    ...
    module Type
      ...
      class ArrayOf
        ...
        def ==(other)
          ...
          other.is_a?(Openlayer::Internal::Type::ArrayOf) && other.nilable? == nilable? && other.item_type == item_type
          ...
          value
            .map do |item|
              ...
              in [true, nil]
                ...
                Openlayer::Internal::Type::Converter.coerce(target, item, state: state)
              end
            end
        end
        ...
        # @return [Object]
        def to_sorbet_type
          T::Array[Openlayer::Internal::Util::SorbetRuntimeSupport.to_sorbet_type(item_type)]
        end
