...
module Openlayer
  module Models
    ...
    class InferencePipelineRetrieveResponse < Openlayer::Internal::Type::BaseModel
      ...
      #
      #   @return [Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::BigQueryDataBackend, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DefaultDataBackend, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::SnowflakeDataBackend, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DatabricksDtlDataBackend, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::RedshiftDataBackend, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::PostgresDataBackend, nil]
      optional :data_backend,
               union: -> { Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend },
      ...
      #
      #   @param data_backend [Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::BigQueryDataBackend, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DefaultDataBackend, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::SnowflakeDataBackend, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DatabricksDtlDataBackend, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::RedshiftDataBackend, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::PostgresDataBackend, nil]
      #
      ...
      # @see Openlayer::Models::InferencePipelineRetrieveResponse#data_backend
      module DataBackend
        extend Openlayer::Internal::Type::Union

        variant -> { Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::BigQueryDataBackend }

        variant -> { Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DefaultDataBackend }

        variant -> { Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::SnowflakeDataBackend }

        variant -> { Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DatabricksDtlDataBackend }

        variant -> { Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::RedshiftDataBackend }

        variant -> { Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::PostgresDataBackend }

        class BigQueryDataBackend < Openlayer::Internal::Type::BaseModel
          # @!attribute backend_type
          #
          #   @return [Symbol, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::BigQueryDataBackend::BackendType]
          ...
          #
          #   @return [Symbol, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::BigQueryDataBackend::PartitionType, nil]
          ...
          #   @param backend_type [Symbol, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::BigQueryDataBackend::BackendType]
          #   @param bigquery_connection_id [String, nil]
          #   @param dataset_id [String]
          #   @param project_id [String]
          #   @param table_id [String, nil]
          #   @param partition_type [Symbol, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::BigQueryDataBackend::PartitionType, nil]

          # @see Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::BigQueryDataBackend#backend_type
          module BackendType
            extend Openlayer::Internal::Type::Enum
          ...
          # @see Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::BigQueryDataBackend#config
          class Config < Openlayer::Internal::Type::BaseModel
            ...
            #   {Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::BigQueryDataBackend::Config}
            #   for more details.
            #
          ...
          # @see Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::BigQueryDataBackend#partition_type
        ...
        class DefaultDataBackend < Openlayer::Internal::Type::BaseModel
          # @!attribute backend_type
          #
          #   @return [Symbol, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DefaultDataBackend::BackendType]
          required :backend_type,
                   enum: -> { Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DefaultDataBackend::BackendType },
                   api_name: :backendType

          # @!method initialize(backend_type:)
          #   @param backend_type [Symbol, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DefaultDataBackend::BackendType]

          # @see Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DefaultDataBackend#backend_type
          module BackendType
            extend Openlayer::Internal::Type::Enum
        ...
        class SnowflakeDataBackend < Openlayer::Internal::Type::BaseModel
          # @!attribute backend_type
          #
          #   @return [Symbol, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::SnowflakeDataBackend::BackendType]
          required :backend_type,
                   enum: -> { Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::SnowflakeDataBackend::BackendType },
                   api_name: :backendType
          ...
          #   @param backend_type [Symbol, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::SnowflakeDataBackend::BackendType]
          #   @param database [String]
          #   @param schema [String]
          #   @param snowflake_connection_id [String, nil]
          #   @param table [String, nil]

          # @see Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::SnowflakeDataBackend#backend_type
          module BackendType
            extend Openlayer::Internal::Type::Enum
          ...
          # @see Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::SnowflakeDataBackend#config
          class Config < Openlayer::Internal::Type::BaseModel
            # @!attribute ground_truth_column_name
            #   Name of the column with the ground truths.
            #
            ...
            # @!method initialize(ground_truth_column_name: nil, human_feedback_column_name: nil, latency_column_name: nil, timestamp_column_name: nil)
            #   Some parameter documentations has been truncated, see
            #   {Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::SnowflakeDataBackend::Config}
            #   for more details.
            #
            #   @param ground_truth_column_name [String, nil] Name of the column with the ground truths.
            #
        ...
        class DatabricksDtlDataBackend < Openlayer::Internal::Type::BaseModel
          # @!attribute backend_type
          #
          #   @return [Symbol, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DatabricksDtlDataBackend::BackendType]
          required :backend_type,
                   enum: -> { Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DatabricksDtlDataBackend::BackendType },
                   api_name: :backendType
          ...
          #   @param backend_type [Symbol, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DatabricksDtlDataBackend::BackendType]
          #   @param databricks_dtl_connection_id [String, nil]
          #   @param table_id [String, nil]

          # @see Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DatabricksDtlDataBackend#backend_type
          module BackendType
            extend Openlayer::Internal::Type::Enum
          ...
          # @see Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DatabricksDtlDataBackend#config
          class Config < Openlayer::Internal::Type::BaseModel
            # @!attribute ground_truth_column_name
            #   Name of the column with the ground truths.
            #
            ...
            # @!method initialize(ground_truth_column_name: nil, human_feedback_column_name: nil, latency_column_name: nil, timestamp_column_name: nil)
            #   Some parameter documentations has been truncated, see
            #   {Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DatabricksDtlDataBackend::Config}
            #   for more details.
            #
            #   @param ground_truth_column_name [String, nil] Name of the column with the ground truths.
            #
        ...
        class RedshiftDataBackend < Openlayer::Internal::Type::BaseModel
          # @!attribute backend_type
          #
          #   @return [Symbol, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::RedshiftDataBackend::BackendType]
          required :backend_type,
                   enum: -> { Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::RedshiftDataBackend::BackendType },
                   api_name: :backendType
          ...
          #   @param backend_type [Symbol, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::RedshiftDataBackend::BackendType]
          #   @param redshift_connection_id [String, nil]
          #   @param schema_name [String]
          #   @param table_name [String]

          # @see Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::RedshiftDataBackend#backend_type
          module BackendType
            extend Openlayer::Internal::Type::Enum
          ...
          # @see Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::RedshiftDataBackend#config
          class Config < Openlayer::Internal::Type::BaseModel
            # @!attribute ground_truth_column_name
            #   Name of the column with the ground truths.
            #
            ...
            # @!method initialize(ground_truth_column_name: nil, human_feedback_column_name: nil, latency_column_name: nil, timestamp_column_name: nil)
            #   Some parameter documentations has been truncated, see
            #   {Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::RedshiftDataBackend::Config}
            #   for more details.
            #
            #   @param ground_truth_column_name [String, nil] Name of the column with the ground truths.
            #
        ...
        class PostgresDataBackend < Openlayer::Internal::Type::BaseModel
          # @!attribute backend_type
          #
          #   @return [Symbol, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::PostgresDataBackend::BackendType]
          required :backend_type,
                   enum: -> { Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::PostgresDataBackend::BackendType },
                   api_name: :backendType
          ...
          #   @param backend_type [Symbol, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::PostgresDataBackend::BackendType]
          #   @param database [String]
          #   @param postgres_connection_id [String, nil]
          #   @param schema [String]
          #   @param table [String, nil]

          # @see Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::PostgresDataBackend#backend_type
          module BackendType
            extend Openlayer::Internal::Type::Enum
          ...
          # @see Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::PostgresDataBackend#config
          class Config < Openlayer::Internal::Type::BaseModel
            # @!attribute ground_truth_column_name
            #   Name of the column with the ground truths.
            #
            ...
            # @!method initialize(ground_truth_column_name: nil, human_feedback_column_name: nil, latency_column_name: nil, timestamp_column_name: nil)
            #   Some parameter documentations has been truncated, see
            #   {Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::PostgresDataBackend::Config}
            #   for more details.
            #
            #   @param ground_truth_column_name [String, nil] Name of the column with the ground truths.
            #
        ...
        #   @return [Array(Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::BigQueryDataBackend, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DefaultDataBackend, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::SnowflakeDataBackend, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::DatabricksDtlDataBackend, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::RedshiftDataBackend, Openlayer::Models::InferencePipelineRetrieveResponse::DataBackend::PostgresDataBackend)]
      end
