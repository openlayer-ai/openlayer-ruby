  ...
  module Models
    module Governance
      ...
      class RuleListResponse < Openlayer::Internal::Type::BaseModel
        # @!attribute items
        #
        #   @return [Array<Openlayer::Models::Governance::RuleListResponse::Item>]
        required :items,
                 -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::RuleListResponse::Item] }

        # @!method initialize(items:)
        #   @param items [Array<Openlayer::Models::Governance::RuleListResponse::Item>]
