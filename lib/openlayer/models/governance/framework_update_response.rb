...
module Openlayer
  module Models
    module Governance
      ...
      class FrameworkUpdateResponse < Openlayer::Internal::Type::BaseModel
        # @!attribute enabled
        ...
        #
        #   @return [Openlayer::Models::Governance::FrameworkUpdateResponse::Avatar, nil]
        optional :avatar, -> { Openlayer::Models::Governance::FrameworkUpdateResponse::Avatar }, nil?: true
        ...
        #
        #   @return [Openlayer::Models::Governance::FrameworkUpdateResponse::ProjectSelector, nil]
        optional :project_selector,
                 -> { Openlayer::Models::Governance::FrameworkUpdateResponse::ProjectSelector },
        ...
        response_only do
          ...
          #
          #   @return [Openlayer::Models::Governance::FrameworkUpdateResponse::RuleStats, nil]
          optional :rule_stats,
                   -> { Openlayer::Models::Governance::FrameworkUpdateResponse::RuleStats },
                   api_name: :ruleStats
        end
        ...
        #   {Openlayer::Models::Governance::FrameworkUpdateResponse} for more details.
        #
        ...
        #
        #   @param avatar [Openlayer::Models::Governance::FrameworkUpdateResponse::Avatar, nil] The icon shown for the framework.
        #
        ...
        #
        #   @param project_selector [Openlayer::Models::Governance::FrameworkUpdateResponse::ProjectSelector, nil] Determines which projects the framework applies to. An empty or `null` `match` a
        #
        #   @param rule_stats [Openlayer::Models::Governance::FrameworkUpdateResponse::RuleStats] Compliance roll-up for the framework. Present only on `GET /workspaces/{workspac

        # @see Openlayer::Models::Governance::FrameworkUpdateResponse#avatar
        class Avatar < Openlayer::Internal::Type::BaseModel
          # @!attribute type
          #
          #   @return [Symbol, Openlayer::Models::Governance::FrameworkUpdateResponse::Avatar::Type]
          required :type, enum: -> { Openlayer::Models::Governance::FrameworkUpdateResponse::Avatar::Type }
          ...
          #   The icon shown for the framework.
          #
          #   @param type [Symbol, Openlayer::Models::Governance::FrameworkUpdateResponse::Avatar::Type]
          #   @param value [String]

          # @see Openlayer::Models::Governance::FrameworkUpdateResponse::Avatar#type
          module Type
        ...
        # @see Openlayer::Models::Governance::FrameworkUpdateResponse#project_selector
        class ProjectSelector < Openlayer::Internal::Type::BaseModel
          # @!attribute match
          #   Match criteria, ANDed together.
          #
          #   @return [Array<Openlayer::Models::Governance::FrameworkUpdateResponse::ProjectSelector::Match>, nil]
          optional :match,
                   -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::FrameworkUpdateResponse::ProjectSelector::Match] },
                   nil?: true
          ...
          #   array applies the framework to every project in the workspace.
          #
          #   @param match [Array<Openlayer::Models::Governance::FrameworkUpdateResponse::ProjectSelector::Match>, nil] Match criteria, ANDed together.

          class Match < Openlayer::Internal::Type::BaseModel
            # @!attribute property
            #   The project property to match against.
            #
            #   @return [Symbol, Openlayer::Models::Governance::FrameworkUpdateResponse::ProjectSelector::Match::Property]
            required :property,
                     enum: -> { Openlayer::Models::Governance::FrameworkUpdateResponse::ProjectSelector::Match::Property }
            ...
            #   Some parameter documentations has been truncated, see
            #   {Openlayer::Models::Governance::FrameworkUpdateResponse::ProjectSelector::Match}
            #   for more details.
            #
            #   @param property [Symbol, Openlayer::Models::Governance::FrameworkUpdateResponse::ProjectSelector::Match::Property] The project property to match against.
            #
            ...
            # The project property to match against.
            #
            # @see Openlayer::Models::Governance::FrameworkUpdateResponse::ProjectSelector::Match#property
            module Property
              extend Openlayer::Internal::Type::Enum
        ...
        # @see Openlayer::Models::Governance::FrameworkUpdateResponse#rule_stats
        class RuleStats < Openlayer::Internal::Type::BaseModel
          ...
          #
          #   @return [Openlayer::Models::Governance::FrameworkUpdateResponse::RuleStats::ProjectCompletion]
          ...
          #
          #   @return [Openlayer::Models::Governance::FrameworkUpdateResponse::RuleStats::RuleResults]
          ...
          #   Some parameter documentations has been truncated, see
          #   {Openlayer::Models::Governance::FrameworkUpdateResponse::RuleStats} for more
          #   details.
          #
          #   Compliance roll-up for the framework. Present only on
          #   `GET /workspaces/{workspaceId}/frameworks` when the request sets
          #   `includeRuleStats=true`.
          #
          #   @param project_completion [Openlayer::Models::Governance::FrameworkUpdateResponse::RuleStats::ProjectCompletion] How many of the framework's projects fall into each completion band, where a pro
          #
          #   @param rule_results [Openlayer::Models::Governance::FrameworkUpdateResponse::RuleStats::RuleResults] Rule result counts by status for this framework, matching what `/workspaces/{wor

          # @see Openlayer::Models::Governance::FrameworkUpdateResponse::RuleStats#project_completion
          ...
          # @see Openlayer::Models::Governance::FrameworkUpdateResponse::RuleStats#rule_results
