...
module Openlayer
  module Models
    module Governance
      ...
      class FrameworkListProjectsResponse < Openlayer::Internal::Type::BaseModel
        # @!attribute items
        #
        #   @return [Array<Openlayer::Models::Governance::FrameworkListProjectsResponse::Item>]
        required :items,
                 -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::FrameworkListProjectsResponse::Item] }

        # @!method initialize(items:)
        #   @param items [Array<Openlayer::Models::Governance::FrameworkListProjectsResponse::Item>]
        ...
        class Item < Openlayer::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::TaskType]
          required :task_type,
                   enum: -> { Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::TaskType },
                   api_name: :taskType
          ...
          response_only do
            ...
            #
            #   @return [Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::Links]
            required :links, -> { Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::Links }
            ...
            #
            #   @return [Symbol, Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::Source, nil]
            required :source,
                     enum: -> { Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::Source },
                     nil?: true
            ...
            # @!attribute git_repo
            #
            #   @return [Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::GitRepo, nil]
            optional :git_repo,
                     -> { Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::GitRepo },
                     api_name: :gitRepo,
                     nil?: true
          end
          ...
          #   {Openlayer::Models::Governance::FrameworkListProjectsResponse::Item} for more
          #   details.
          #
          ...
          #
          #   @param links [Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::Links] Links to the project.
          #
          #   @param monitoring_goal_count [Integer] The number of tests in the monitoring mode of the project.
          #
          #   @param name [String] The project name.
          #
          #   @param source [Symbol, Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::Source, nil] The source of the project.
          #
          #   @param task_type [Symbol, Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::TaskType] The task type of the project.
          #
          ...
          #
          #   @param git_repo [Openlayer::Models::Governance::FrameworkListProjectsResponse::Item::GitRepo, nil]
          #
          ...
          # @see Openlayer::Models::Governance::FrameworkListProjectsResponse::Item#links
          ...
          # The source of the project.
          #
          # @see Openlayer::Models::Governance::FrameworkListProjectsResponse::Item#source
          module Source
          ...
          # The task type of the project.
          #
          # @see Openlayer::Models::Governance::FrameworkListProjectsResponse::Item#task_type
          module TaskType
            extend Openlayer::Internal::Type::Enum
          ...
          # @see Openlayer::Models::Governance::FrameworkListProjectsResponse::Item#git_repo
