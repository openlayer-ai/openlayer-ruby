  ...
  module Models
    module Governance
      ...
      class FrameworkCreateResponse < Openlayer::Internal::Type::BaseModel
        ...
        #
        #   @return [Openlayer::Models::Governance::FrameworkCreateResponse::Avatar, nil]
        ...
        #
        #   @return [Openlayer::Models::Governance::FrameworkCreateResponse::ProjectSelector, nil]
        ...
        response_only do
          ...
          #
          #   @return [Openlayer::Models::Governance::FrameworkCreateResponse::RuleStats, nil]
          optional :rule_stats,
        ...
        #   {Openlayer::Models::Governance::FrameworkCreateResponse} for more details.
        #
        ...
        #
        #   @param avatar [Openlayer::Models::Governance::FrameworkCreateResponse::Avatar, nil] The icon shown for the framework.
        #
        ...
        #
        #   @param project_selector [Openlayer::Models::Governance::FrameworkCreateResponse::ProjectSelector, nil] Determines which projects the framework applies to. An empty or `null` `match` a
        #
        #   @param rule_stats [Openlayer::Models::Governance::FrameworkCreateResponse::RuleStats] Compliance roll-up for the framework. Present only on `GET /workspaces/{workspac

        # @see Openlayer::Models::Governance::FrameworkCreateResponse#avatar
        class Avatar < Openlayer::Internal::Type::BaseModel
          # @!attribute type
          #
          #   @return [Symbol, Openlayer::Models::Governance::FrameworkCreateResponse::Avatar::Type]
          required :type, enum: -> { Openlayer::Models::Governance::FrameworkCreateResponse::Avatar::Type }
          ...
          #   The icon shown for the framework.
          #
          #   @param type [Symbol, Openlayer::Models::Governance::FrameworkCreateResponse::Avatar::Type]
          #   @param value [String]

          # @see Openlayer::Models::Governance::FrameworkCreateResponse::Avatar#type
          module Type
        ...
        # @see Openlayer::Models::Governance::FrameworkCreateResponse#project_selector
        class ProjectSelector < Openlayer::Internal::Type::BaseModel
          # @!attribute match
          #   Match criteria, ANDed together.
          #
          #   @return [Array<Openlayer::Models::Governance::FrameworkCreateResponse::ProjectSelector::Match>, nil]
          optional :match,
          ...
          #   array applies the framework to every project in the workspace.
          #
          #   @param match [Array<Openlayer::Models::Governance::FrameworkCreateResponse::ProjectSelector::Match>, nil] Match criteria, ANDed together.
        ...
        # @see Openlayer::Models::Governance::FrameworkCreateResponse#rule_stats
        class RuleStats < Openlayer::Internal::Type::BaseModel
          ...
          #
          #   @return [Openlayer::Models::Governance::FrameworkCreateResponse::RuleStats::ProjectCompletion]
          ...
          #
          #   @return [Openlayer::Models::Governance::FrameworkCreateResponse::RuleStats::RuleResults]
          ...
          #   Some parameter documentations has been truncated, see
          #   {Openlayer::Models::Governance::FrameworkCreateResponse::RuleStats} for more
          #   details.
          #
          #   Compliance roll-up for the framework. Present only on
          #   `GET /workspaces/{workspaceId}/frameworks` when the request sets
          #   `includeRuleStats=true`.
          #
          #   @param project_completion [Openlayer::Models::Governance::FrameworkCreateResponse::RuleStats::ProjectCompletion] How many of the framework's projects fall into each completion band, where a pro
          #
          #   @param rule_results [Openlayer::Models::Governance::FrameworkCreateResponse::RuleStats::RuleResults] Rule result counts by status for this framework, matching what `/workspaces/{wor

          # @see Openlayer::Models::Governance::FrameworkCreateResponse::RuleStats#project_completion
          ...
          # @see Openlayer::Models::Governance::FrameworkCreateResponse::RuleStats#rule_results
