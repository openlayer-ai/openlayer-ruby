...
module Openlayer
  module Models
    module Governance
      ...
      class RuleResultRetrieveResponse < Openlayer::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Openlayer::Models::Governance::RuleResultRetrieveResponse::Status]
        required :status, enum: -> { Openlayer::Models::Governance::RuleResultRetrieveResponse::Status }
        ...
        #
        #   @return [Array<Openlayer::Models::Governance::RuleResultRetrieveResponse::BlockedBy>, nil]
        optional :blocked_by,
                 -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::RuleResultRetrieveResponse::BlockedBy] },
                 api_name: :blockedBy

        # @!attribute blocking
        #   Rule results that this one blocks.
        #
        #   @return [Array<Openlayer::Models::Governance::RuleResultRetrieveResponse::Blocking>, nil]
        optional :blocking,
                 -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::RuleResultRetrieveResponse::Blocking] }
        ...
        #
        #   @param status [Symbol, Openlayer::Models::Governance::RuleResultRetrieveResponse::Status] The compliance status of the rule for this entity.
        #
        ...
        #
        #   @param blocked_by [Array<Openlayer::Models::Governance::RuleResultRetrieveResponse::BlockedBy>] Rule results that must pass before this one can be satisfied.
        #
        #   @param blocking [Array<Openlayer::Models::Governance::RuleResultRetrieveResponse::Blocking>] Rule results that this one blocks.
        #
        ...
        # The compliance status of the rule for this entity.
        #
        # @see Openlayer::Models::Governance::RuleResultRetrieveResponse#status
        module Status
        ...
        class BlockedBy < Openlayer::Internal::Type::BaseModel
          ...
          #   The compliance status of the rule for this entity.
          #
          #   @return [Symbol, Openlayer::Models::Governance::RuleResultRetrieveResponse::BlockedBy::Status, nil]
          optional :status,
                   enum: -> { Openlayer::Models::Governance::RuleResultRetrieveResponse::BlockedBy::Status }

          # @!method initialize(id: nil, status: nil)
          #   @param id [String]
          #
          #   @param status [Symbol, Openlayer::Models::Governance::RuleResultRetrieveResponse::BlockedBy::Status] The compliance status of the rule for this entity.

          # The compliance status of the rule for this entity.
          #
          # @see Openlayer::Models::Governance::RuleResultRetrieveResponse::BlockedBy#status
          module Status
            extend Openlayer::Internal::Type::Enum
        ...
        class Blocking < Openlayer::Internal::Type::BaseModel
          ...
          #   The compliance status of the rule for this entity.
          #
          #   @return [Symbol, Openlayer::Models::Governance::RuleResultRetrieveResponse::Blocking::Status, nil]
          optional :status, enum: -> { Openlayer::Models::Governance::RuleResultRetrieveResponse::Blocking::Status }

          # @!method initialize(id: nil, status: nil)
          #   @param id [String]
          #
          #   @param status [Symbol, Openlayer::Models::Governance::RuleResultRetrieveResponse::Blocking::Status] The compliance status of the rule for this entity.

          # The compliance status of the rule for this entity.
          #
          # @see Openlayer::Models::Governance::RuleResultRetrieveResponse::Blocking#status
          module Status
            extend Openlayer::Internal::Type::Enum
