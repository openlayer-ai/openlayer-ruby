...
module Openlayer
  module Models
    module Governance
      # @see Openlayer::Resources::Governance::Frameworks#list_rules
      class FrameworkListRulesResponse < Openlayer::Internal::Type::BaseModel
        # @!attribute items
        #
        #   @return [Array<Openlayer::Models::Governance::FrameworkListRulesResponse::Item>]
        required :items,
                 -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::FrameworkListRulesResponse::Item] }

        # @!method initialize(items:)
        #   @param items [Array<Openlayer::Models::Governance::FrameworkListRulesResponse::Item>]
        ...
        class Item < Openlayer::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Scope]
          required :scope, enum: -> { Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Scope }
          ...
          #
          #   @return [Symbol, Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Type]
          required :type, enum: -> { Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Type }
          ...
          #
          #   @return [Symbol, Openlayer::Models::Governance::FrameworkListRulesResponse::Item::EvidenceType, nil]
          optional :evidence_type,
                   enum: -> { Openlayer::Models::Governance::FrameworkListRulesResponse::Item::EvidenceType },
          ...
          response_only do
            ...
            #
            #   @return [Array<Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework>, nil]
            optional :frameworks,
                     -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework] }
            ...
            #
            #   @return [Array<Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result>, nil]
            optional :results,
                     -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result] }
            ...
            #
            #   @return [Openlayer::Models::Governance::FrameworkListRulesResponse::Item::ResultsSummary, nil]
            optional :results_summary,
                     -> { Openlayer::Models::Governance::FrameworkListRulesResponse::Item::ResultsSummary },
            ...
            #
            #   @return [Array<Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Tag>, nil]
            optional :tags,
                     -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Tag] },
                     nil?: true
          end
          ...
          #   {Openlayer::Models::Governance::FrameworkListRulesResponse::Item} for more
          #   details.
          #
          ...
          #
          #   @param scope [Symbol, Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Scope] Whether the rule is evaluated once for the whole workspace, or once per project
          #
          #   @param type [Symbol, Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Type] `platform` rules are evaluated automatically from the state of your Openlayer wo
          #
          ...
          #
          #   @param evidence_type [Symbol, Openlayer::Models::Governance::FrameworkListRulesResponse::Item::EvidenceType, nil] The kind of evidence that satisfies the rule. `null` for platform rules.
          #
          #   @param frameworks [Array<Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework>] The frameworks that include this rule.
          #
          ...
          #
          #   @param results [Array<Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result>] The rule's results, one per entity the rule is evaluated against. Only returned
          #
          #   @param results_summary [Openlayer::Models::Governance::FrameworkListRulesResponse::Item::ResultsSummary, nil] Pass-rate counts across all of the rule's entities, independent of any status fi
          #
          #   @param tags [Array<Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Tag>, nil] The rule tags associated with the rule.

          # Whether the rule is evaluated once for the whole workspace, or once per project
          # the rule's frameworks apply to.
          #
          # @see Openlayer::Models::Governance::FrameworkListRulesResponse::Item#scope
          module Scope
          ...
          # workspace. `evidence` rules are satisfied by attaching evidence.
          #
          # @see Openlayer::Models::Governance::FrameworkListRulesResponse::Item#type
          module Type
            extend Openlayer::Internal::Type::Enum
          ...
          # The kind of evidence that satisfies the rule. `null` for platform rules.
          #
          # @see Openlayer::Models::Governance::FrameworkListRulesResponse::Item#evidence_type
          module EvidenceType
            extend Openlayer::Internal::Type::Enum
          ...
          class Framework < Openlayer::Internal::Type::BaseModel
            ...
            #
            #   @return [Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework::Avatar, nil]
            required :avatar,
            ...
            #   Some parameter documentations has been truncated, see
            #   {Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework} for
            #   more details.
            #
            #   @param id [String] The framework id.
            #
            #   @param avatar [Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework::Avatar, nil] The icon shown for the framework.
            #
            ...
            # @see Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework#avatar
            class Avatar < Openlayer::Internal::Type::BaseModel
              # @!attribute type
              #
              #   @return [Symbol, Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework::Avatar::Type]
              required :type,
                       enum: -> { Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework::Avatar::Type }
              ...
              #   The icon shown for the framework.
              #
              #   @param type [Symbol, Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework::Avatar::Type]
              #   @param value [String]

              # @see Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Framework::Avatar#type
              module Type
                extend Openlayer::Internal::Type::Enum
          ...
          class Result < Openlayer::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Status]
            required :status,
                     enum: -> { Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Status }
            ...
            #
            #   @return [Array<Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::BlockedBy>, nil]
            optional :blocked_by,
                     -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::BlockedBy] },
                     api_name: :blockedBy

            # @!attribute blocking
            #   Rule results that this one blocks.
            #
            #   @return [Array<Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Blocking>, nil]
            optional :blocking,
                     -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Blocking] }
            ...
            #
            #   @param status [Symbol, Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Status] The compliance status of the rule for this entity.
            #
            ...
            #
            #   @param blocked_by [Array<Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::BlockedBy>] Rule results that must pass before this one can be satisfied.
            #
            #   @param blocking [Array<Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Blocking>] Rule results that this one blocks.
            #
            ...
            # The compliance status of the rule for this entity.
            #
            # @see Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result#status
            module Status
              extend Openlayer::Internal::Type::Enum
            ...
            class BlockedBy < Openlayer::Internal::Type::BaseModel
              ...
              #   The compliance status of the rule for this entity.
              #
              #   @return [Symbol, Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::BlockedBy::Status, nil]
              optional :status,
                       enum: -> { Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::BlockedBy::Status }

              # @!method initialize(id: nil, status: nil)
              #   @param id [String]
              #
              #   @param status [Symbol, Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::BlockedBy::Status] The compliance status of the rule for this entity.

              # The compliance status of the rule for this entity.
              #
              # @see Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::BlockedBy#status
              module Status
                extend Openlayer::Internal::Type::Enum
            ...
            class Blocking < Openlayer::Internal::Type::BaseModel
              ...
              #   The compliance status of the rule for this entity.
              #
              #   @return [Symbol, Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Blocking::Status, nil]
              optional :status,
                       enum: -> { Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Blocking::Status }

              # @!method initialize(id: nil, status: nil)
              #   @param id [String]
              #
              #   @param status [Symbol, Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Blocking::Status] The compliance status of the rule for this entity.

              # The compliance status of the rule for this entity.
              #
              # @see Openlayer::Models::Governance::FrameworkListRulesResponse::Item::Result::Blocking#status
              module Status
                extend Openlayer::Internal::Type::Enum
          ...
          # @see Openlayer::Models::Governance::FrameworkListRulesResponse::Item#results_summary
