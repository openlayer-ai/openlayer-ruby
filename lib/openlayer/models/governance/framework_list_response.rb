...
module Openlayer
  module Models
    module Governance
      ...
      class FrameworkListResponse < Openlayer::Internal::Type::BaseModel
        # @!attribute items
        #
        #   @return [Array<Openlayer::Models::Governance::FrameworkListResponse::Item>]
        required :items,
                 -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::FrameworkListResponse::Item] }

        # @!method initialize(items:)
        #   @param items [Array<Openlayer::Models::Governance::FrameworkListResponse::Item>]
        ...
        class Item < Openlayer::Internal::Type::BaseModel
          ...
          #
          #   @return [Openlayer::Models::Governance::FrameworkListResponse::Item::Avatar, nil]
          optional :avatar, -> { Openlayer::Models::Governance::FrameworkListResponse::Item::Avatar }, nil?: true
          ...
          #
          #   @return [Openlayer::Models::Governance::FrameworkListResponse::Item::ProjectSelector, nil]
          optional :project_selector,
                   -> { Openlayer::Models::Governance::FrameworkListResponse::Item::ProjectSelector },
          ...
          response_only do
            ...
            #
            #   @return [Openlayer::Models::Governance::FrameworkListResponse::Item::RuleStats, nil]
            optional :rule_stats,
                     -> { Openlayer::Models::Governance::FrameworkListResponse::Item::RuleStats },
                     api_name: :ruleStats
          end
          ...
          #   {Openlayer::Models::Governance::FrameworkListResponse::Item} for more details.
          #
          ...
          #
          #   @param avatar [Openlayer::Models::Governance::FrameworkListResponse::Item::Avatar, nil] The icon shown for the framework.
          #
          ...
          #
          #   @param project_selector [Openlayer::Models::Governance::FrameworkListResponse::Item::ProjectSelector, nil] Determines which projects the framework applies to. An empty or `null` `match` a
          #
          #   @param rule_stats [Openlayer::Models::Governance::FrameworkListResponse::Item::RuleStats] Compliance roll-up for the framework. Present only on `GET /workspaces/{workspac

          # @see Openlayer::Models::Governance::FrameworkListResponse::Item#avatar
          class Avatar < Openlayer::Internal::Type::BaseModel
            # @!attribute type
            #
            #   @return [Symbol, Openlayer::Models::Governance::FrameworkListResponse::Item::Avatar::Type]
            required :type, enum: -> { Openlayer::Models::Governance::FrameworkListResponse::Item::Avatar::Type }
            ...
            #   The icon shown for the framework.
            #
            #   @param type [Symbol, Openlayer::Models::Governance::FrameworkListResponse::Item::Avatar::Type]
            #   @param value [String]

            # @see Openlayer::Models::Governance::FrameworkListResponse::Item::Avatar#type
            module Type
          ...
          # @see Openlayer::Models::Governance::FrameworkListResponse::Item#project_selector
          class ProjectSelector < Openlayer::Internal::Type::BaseModel
            # @!attribute match
            #   Match criteria, ANDed together.
            #
            #   @return [Array<Openlayer::Models::Governance::FrameworkListResponse::Item::ProjectSelector::Match>, nil]
            optional :match,
                     -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::FrameworkListResponse::Item::ProjectSelector::Match] },
                     nil?: true
            ...
            #   array applies the framework to every project in the workspace.
            #
            #   @param match [Array<Openlayer::Models::Governance::FrameworkListResponse::Item::ProjectSelector::Match>, nil] Match criteria, ANDed together.

            class Match < Openlayer::Internal::Type::BaseModel
              # @!attribute property
              #   The project property to match against.
              #
              #   @return [Symbol, Openlayer::Models::Governance::FrameworkListResponse::Item::ProjectSelector::Match::Property]
              required :property,
                       enum: -> { Openlayer::Models::Governance::FrameworkListResponse::Item::ProjectSelector::Match::Property }
              ...
              #   for more details.
              #
              #   @param property [Symbol, Openlayer::Models::Governance::FrameworkListResponse::Item::ProjectSelector::Match::Property] The project property to match against.
              #
              ...
              # The project property to match against.
              #
              # @see Openlayer::Models::Governance::FrameworkListResponse::Item::ProjectSelector::Match#property
              module Property
                extend Openlayer::Internal::Type::Enum
          ...
          # @see Openlayer::Models::Governance::FrameworkListResponse::Item#rule_stats
          class RuleStats < Openlayer::Internal::Type::BaseModel
            ...
            #
            #   @return [Openlayer::Models::Governance::FrameworkListResponse::Item::RuleStats::ProjectCompletion]
            required :project_completion,
                     -> { Openlayer::Models::Governance::FrameworkListResponse::Item::RuleStats::ProjectCompletion },
            ...
            #
            #   @return [Openlayer::Models::Governance::FrameworkListResponse::Item::RuleStats::RuleResults]
            required :rule_results,
                     -> { Openlayer::Models::Governance::FrameworkListResponse::Item::RuleStats::RuleResults },
                     api_name: :ruleResults

            # @!method initialize(project_completion:, rule_results:)
            #   Some parameter documentations has been truncated, see
            #   {Openlayer::Models::Governance::FrameworkListResponse::Item::RuleStats} for more
            #   details.
            #
            #   Compliance roll-up for the framework. Present only on
            #   `GET /workspaces/{workspaceId}/frameworks` when the request sets
            #   `includeRuleStats=true`.
            #
            #   @param project_completion [Openlayer::Models::Governance::FrameworkListResponse::Item::RuleStats::ProjectCompletion] How many of the framework's projects fall into each completion band, where a pro
            #
            #   @param rule_results [Openlayer::Models::Governance::FrameworkListResponse::Item::RuleStats::RuleResults] Rule result counts by status for this framework, matching what `/workspaces/{wor

            # @see Openlayer::Models::Governance::FrameworkListResponse::Item::RuleStats#project_completion
            ...
            # @see Openlayer::Models::Governance::FrameworkListResponse::Item::RuleStats#rule_results
