...
module Openlayer
  module Models
    module Governance
      ...
      class RuleCreateResponse < Openlayer::Internal::Type::BaseModel
        # @!attribute name
        #   The rule name.
        #
        #   @return [String]
        ...
        optional :evidence_type,
                 enum: -> { Openlayer::Models::Governance::RuleCreateResponse::EvidenceType },
        ...
        response_only do
          ...
          #
          #   @return [Array<Openlayer::Models::Governance::RuleCreateResponse::Framework>, nil]
          optional :frameworks,
          ...
          #
          #   @return [Array<Openlayer::Models::Governance::RuleCreateResponse::Result>, nil]
          optional :results,
                   -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::RuleCreateResponse::Result] }
          ...
          #
          #   @return [Openlayer::Models::Governance::RuleCreateResponse::ResultsSummary, nil]
          optional :results_summary,
                   -> { Openlayer::Models::Governance::RuleCreateResponse::ResultsSummary },
          ...
          #
          #   @return [Array<Openlayer::Models::Governance::RuleCreateResponse::Tag>, nil]
          optional :tags,
                   -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::RuleCreateResponse::Tag] },
                   nil?: true
        end
        ...
        #
        #   @param scope [Symbol, Openlayer::Models::Governance::RuleCreateResponse::Scope] Whether the rule is evaluated once for the whole workspace, or once per project
        #
        #   @param type [Symbol, Openlayer::Models::Governance::RuleCreateResponse::Type] `platform` rules are evaluated automatically from the state of your Openlayer wo
        #
        ...
        #
        #   @param results [Array<Openlayer::Models::Governance::RuleCreateResponse::Result>] The rule's results, one per entity the rule is evaluated against. Only returned
        #
        #   @param results_summary [Openlayer::Models::Governance::RuleCreateResponse::ResultsSummary, nil] Pass-rate counts across all of the rule's entities, independent of any status fi
        #
        ...
        class Framework < Openlayer::Internal::Type::BaseModel
          ...
          #
          #   @return [Openlayer::Models::Governance::RuleCreateResponse::Framework::Avatar, nil]
          required :avatar, -> { Openlayer::Models::Governance::RuleCreateResponse::Framework::Avatar }, nil?: true
          ...
          #   Some parameter documentations has been truncated, see
          #   {Openlayer::Models::Governance::RuleCreateResponse::Framework} for more details.
          #
          #   @param id [String] The framework id.
          #
          #   @param avatar [Openlayer::Models::Governance::RuleCreateResponse::Framework::Avatar, nil] The icon shown for the framework.
          #
          ...
          # @see Openlayer::Models::Governance::RuleCreateResponse::Framework#avatar
          class Avatar < Openlayer::Internal::Type::BaseModel
            # @!attribute type
            #
            #   @return [Symbol, Openlayer::Models::Governance::RuleCreateResponse::Framework::Avatar::Type]
            required :type, enum: -> { Openlayer::Models::Governance::RuleCreateResponse::Framework::Avatar::Type }
            ...
            #   The icon shown for the framework.
            #
            #   @param type [Symbol, Openlayer::Models::Governance::RuleCreateResponse::Framework::Avatar::Type]
            #   @param value [String]

            # @see Openlayer::Models::Governance::RuleCreateResponse::Framework::Avatar#type
            module Type
              extend Openlayer::Internal::Type::Enum
        ...
        class Result < Openlayer::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Openlayer::Models::Governance::RuleCreateResponse::Result::BlockedBy>, nil]
          optional :blocked_by,
                   -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::RuleCreateResponse::Result::BlockedBy] },
                   api_name: :blockedBy

          # @!attribute blocking
          #   Rule results that this one blocks.
          #
          #   @return [Array<Openlayer::Models::Governance::RuleCreateResponse::Result::Blocking>, nil]
          optional :blocking,
          ...
          #
          #   @param blocked_by [Array<Openlayer::Models::Governance::RuleCreateResponse::Result::BlockedBy>] Rule results that must pass before this one can be satisfied.
          #
          #   @param blocking [Array<Openlayer::Models::Governance::RuleCreateResponse::Result::Blocking>] Rule results that this one blocks.
          #
        ...
        # @see Openlayer::Models::Governance::RuleCreateResponse#results_summary
