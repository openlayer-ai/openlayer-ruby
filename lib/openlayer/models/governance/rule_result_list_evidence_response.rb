...
module Openlayer
  module Models
    module Governance
      ...
      class RuleResultListEvidenceResponse < Openlayer::Internal::Type::BaseModel
        # @!attribute items
        #
        #   @return [Array<Openlayer::Models::Governance::RuleResultListEvidenceResponse::Item>]
        required :items,
                 -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::RuleResultListEvidenceResponse::Item] }

        # @!method initialize(items:)
        #   @param items [Array<Openlayer::Models::Governance::RuleResultListEvidenceResponse::Item>]
        ...
        class Item < Openlayer::Internal::Type::BaseModel
          ...
          #   {Openlayer::Models::Governance::RuleResultListEvidenceResponse::Item} for more
          #   details.
          #
