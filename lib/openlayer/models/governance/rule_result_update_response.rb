  ...
  module Models
    module Governance
      ...
      class RuleResultUpdateResponse < Openlayer::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Openlayer::Models::Governance::RuleResultUpdateResponse::BlockedBy>, nil]
        optional :blocked_by,
                 -> { Openlayer::Internal::Type::ArrayOf[Openlayer::Models::Governance::RuleResultUpdateResponse::BlockedBy] },
                 api_name: :blockedBy

        # @!attribute blocking
        #   Rule results that this one blocks.
        #
        #   @return [Array<Openlayer::Models::Governance::RuleResultUpdateResponse::Blocking>, nil]
        optional :blocking,
        ...
        #
        #   @param blocked_by [Array<Openlayer::Models::Governance::RuleResultUpdateResponse::BlockedBy>] Rule results that must pass before this one can be satisfied.
        #
        #   @param blocking [Array<Openlayer::Models::Governance::RuleResultUpdateResponse::Blocking>] Rule results that this one blocks.
        #
